...
export function ContentCard({
  ...
  return (
    <Card className="group overflow-hidden border-0 shadow-md hover:shadow-xl transition-all duration-300 rounded-2xl bg-card">
      ...
      <CardContent className="p-5">
        <h3 className="font-bold text-lg mb-3 line-clamp-2 leading-tight tracking-tight group-hover:text-primary transition-colors">
          {title}
        </h3>
